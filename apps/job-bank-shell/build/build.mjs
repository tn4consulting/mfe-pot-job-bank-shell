...
const result = await runEsBuildBuilder('apps/job-bank-shell/federation.config.mjs', {
...
console.log(`job-bank-shell built to ${outputPath} (${dev ? 'development' : 'production'})`);
